...
1. **Browse Components** - Visit [react-blocks.dev/components](https://react-blocks.dev/components)
2. **Copy the Code** - Click "View Code" and copy the component
3. **Paste Into Your Project** - Create a new file and paste the code
...
- **Change Colors** - Replace color classes (e.g., `bg-blue-600` → `bg-purple-600`)
- **Adjust Sizes** - Modify padding, margins, or font sizes
- **Add Animations** - Integrate Framer Motion, GSAP, or other libraries
- **Dark Mode** - All components use Tailwind's `dark:` variants

You own the code, so modify it however you need!

## 📚 Documentation

Full documentation is available at [react-blocks.dev/documentation](https://react-blocks.dev/documentation)
...
2. **Request Features** - Share your ideas for new components
3. **Star the Repo** - Support ongoing development
...
- **Website:** [react-blocks.dev](https://react-blocks.dev)
- **Components:** [react-blocks.dev/components](https://react-blocks.dev/components)
- **Documentation:** [react-blocks.dev/documentation](https://react-blocks.dev/documentation)
- **Twitter:** [@daahaamm](https://x.com/daahaamm)

## 💬 Support

Need help? Have questions?

- Check our [FAQ](https://react-blocks.dev/faq)
- Open an issue on GitHub
- Contact us through our [contact page](https://react-blocks.dev/contact)
...
<div align="center">
  <p>Built with ❤️ by <a href="https://x.com/daahaamm">Daham Senarathne</a></p>
  <p>Made for developers who value simplicity, speed, and clean code.</p>
</div>
